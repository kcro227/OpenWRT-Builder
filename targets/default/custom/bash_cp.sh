...
FIRMWARE_PATTERNS=(
 ...
 # ["default"] : default 型号的固件将被复制到 path/to/default/destination 目录下
 # ["default"] 中的default是固件文件名中包含的关键字，path/to/default/destination是你希望复制到的目标路径
declare -A MODEL_DEST=(
    # ["default"]="path/to/default/destination"
)
